...
public class JSClassVisitor extends AbstractClassVisitor {
    private JSClass myDecompiledJavaClass = null;
    ...
    public void visit(final int version, final int access, final String name
        ...
        myDecompiledJavaClass = new JSClass(modifier, type, className, packageName.toString(), implementedInterfaces
    ...
    public MethodVisitor visitMethod(final int access, final String name, final String desc
        ...
        final JSClassMethod javaClassMethod = new JSClassMethod(modifier, returnType, name
        ...
        return new JSMethodVisitor(javaClassMethod
                , myDecompiledJavaClass.getPackage() + "." + myDecompiledJavaClass.getName());
    }

    @Override
    public void visitEnd() {
        for (final JSClassMethod method : myDecompiledJavaClass.getMethods()) {
    ...
    private void addInformationAboutParameters(final String descriptor, final JSClassMethod javaClassMethod) {
        int count = 0;
        int pos = 0;
