...
@Deprecated
public abstract class OldAbstractFrame {
    ...
    protected OldAbstractFrame myParent = null;
    protected List<OldAbstractFrame> myChildren = new ArrayList<OldAbstractFrame>();
    protected OldAbstractFrame mySameAbstractFrame = null;
    protected OldAbstractFrame myChopAbstractFrame = null;
    ...
    public OldAbstractFrame getParent() {
        return myParent;
    }

    public void setParent(final OldAbstractFrame parent) {
        this.myParent = parent;
    }

    public void setSameFrame(final OldAbstractFrame sameAbstractFrame) {
        this.mySameAbstractFrame = sameAbstractFrame;
    }

    public void setChopFrame(final OldAbstractFrame chopAbstractFrame) {
    ...
    public void addChild(final OldAbstractFrame child) {
    ...
    public boolean addLocalVariableFromDebugInfo(final int index, final String name, final String type) {
        if (!containsIndex(index) || myLocalVariablesFromDebugInfo.contains(index)) {
            for (final OldAbstractFrame abstractFrame : myChildren) {
